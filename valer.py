...
def crop_back_to_original(padded_image, original_size, padded_size):
    original_h, original_w = original_size
    padded_h, padded_w = padded_size
    
    pad_y = (padded_h - original_h) // 2
    pad_x = (padded_w - original_w) // 2
    
    crop_area = (pad_x, pad_y, pad_x + original_w, pad_y + original_h)
    
    cropped_image = padded_image.crop(crop_area)
