...
if __name__ == "__main__":
    ...
    parser.add_argument("--nusc_ckpt_path", type=str,  default="", help="")
    ...
    if args.training:
        ...
        valer = Valer(config)
        synchronize()
        valer.start_validation()
    elif args.generation:
        from gener import Gener
        gener = Gener(config)
        synchronize()
        gener.start_validation(is_train=False) # False means validation, True means train
    else:
        NotImplementedError