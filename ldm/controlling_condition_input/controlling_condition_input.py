...
class EncodingNetInput:
    ...
    def prepare(self, batch):
        ...
        return {"box":box, "box_mask":box_mask, "positive_embeddings":positive_embeddings, "perl_box_masking_map":perl_box_masking_map, "context":context}
    ...
    def get_null_input(self, batch=None, device=None, dtype=None):
        ...
        return {"box":box, "box_mask":box_mask, "positive_embeddings":positive_embeddings, "perl_box_masking_map":perl_box_masking_map, "context":self.ucontext}
